...
<xsl:text>&#xa;</xsl:text>
    ...
    <body>
	    ...
	    <xsl:for-each select="subprojects">
            ...
            <xsl:for-each select="subprojects/subproject[@id='gardens']">
	...
	<xsl:for-each select="archives/archive">
		<ul>
		<li>Archive Name: <xsl:value-of select="name"/></li>
		<li>Archive URL: 
                  <xsl:element name="a">
		...
		<li>Repository Name: <xsl:value-of select="repository/name"/></li>
   		  <li>Repository URL: 
                  <xsl:element name="a">
                  <xsl:attribute name="href">
		...
		<li>Repository Update: <xsl:value-of select="repository/update"/></li>
		<li>Number of Entries: <xsl:value-of select="repository/entities"/></li>
	        <xsl:for-each select="repository/format">
			<li>Format: <xsl:value-of select="."/></li>
                </xsl:for-each>
	        </ul>
         </xsl:for-each>
    </xsl:for-each>
    ...
    <xsl:for-each select="ent">
		...
		<li>
		  ...
		  Pluscode: <xsl:value-of select="geography/pluscode"/>
		</li>
        </xsl:when>
        </xsl:choose>
